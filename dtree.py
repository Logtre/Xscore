...
from preproc_classify import PreprocClassify
from decision_tree import DecTree
...
# --- preproc_classify ---
preproc = PreprocClassify(inifile.get('preproc_classify', 'id_path'),inifile.get('preproc_classify', 'in_path'),inifile.get('general', 'char_type'))

# 識別器の前処理
preproc.make_class_data(inifile.get('preproc_classify', 'out_path'))

# --- decision_tree_regression ---
dt = DecTree()

# 重回帰分析
dt.regression(inifile.get('preproc_classify', 'out_path'),inifile.get('regression', 'all_path'))
